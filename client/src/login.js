...
{ {status}==="Logged in successfully"?<div style={{color:"white"}} class="alert alert-success" role="alert">
  {status}
</div>:<div style={{backgroundColor:"transparent" , color:"white",border:"none",display:"flex", justifyContent:"center",alignItems:"center"}} class="alert alert-danger" role="alert">
  {status}
</div>}
